  ...
  return (
    ...
    >
      <div className="row mt-5">
        <div className="col-12 col-md-4 col-lg-3 mb-4 footer-icons">
          <img src="media/images/logo.svg" style={{ width: "140px", maxWidth: "100%" }} alt="logo" />{" "}
          <br /> <br />
          ...
          <a href="#!"><i className="fa-brands fa-linkedin-in"></i></a> <br />
        ...
        <div className="col-6 col-sm-6 col-md-2 mb-4 footer-links">
          <p>Account</p>
        ...
        <div className="col-6 col-sm-6 col-md-3 mb-4 footer-links">
          <p>Quick links</p>
      ...
      <div className="mt-5 text-muted" style={{ fontSize: "12px" }}>
        ...
        <p>
          ...
          <br /> <br /> India's largest broker based on networth as per NSE. NSE
          broker factsheet
        </p>
        <p>
